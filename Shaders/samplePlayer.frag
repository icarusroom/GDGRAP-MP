...
uniform sampler2D metallicsTex;
...
void main()
{
	...
	FragColor = vec4(pointLightResult + directionalLightResult, 1.0) * texture(tex0, texCoord) * texture(roughnessTex, texCoord) * texture(AOTex, texCoord);
}